...
/* This function can be called only if root has a left child. Perform a 
* rotate between a node root and its left child. Update heights, then return
* newroot. 
*/
...
/* This function can be called only if root has a right child. Perform a
* rotate between a node root and its right child. Update heights, then
* return newroot. 
*/
